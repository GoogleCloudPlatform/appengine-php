...
typedef struct _sapi_globals_struct {
  ...
  // Array of path roots for files that are accessible from the interpreter.
  // We use this NULL terminated list of strings to prevent PHP from trying to
  // walk outside of the accessible paths, which generate warnings in the
  // appserver logs.
  const char** application_path_roots;
} sapi_globals_struct;
