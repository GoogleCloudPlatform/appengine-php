...
ZEND_API void zend_timeout(int dummy) /* {{{ */
{
	...
	if (zend_on_timeout) {
		...
		*/
        ...
        // This error is shown in the applications logs - as we don't know
        // what the deadline was, make it a generic message. The user can see
        // the request time in the logs.
	zend_error(E_ERROR, "The request was aborted because it exceeded the maximum execution time.");
}
/* }}} */
