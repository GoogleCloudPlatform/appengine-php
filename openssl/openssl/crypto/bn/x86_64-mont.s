...
.align	16
.Lsqr4x_copy:
	movdqu	(%rbx,%rbp,1),%xmm2
	movdqu	16(%rbx,%rbp,1),%xmm4
	movdqu	(%rdi,%rbp,1),%xmm1
	movdqu	16(%rdi,%rbp,1),%xmm3
	pxor	%xmm1,%xmm2
	pxor	%xmm3,%xmm4
	pand	%xmm0,%xmm2
	pand	%xmm0,%xmm4
	pxor	%xmm1,%xmm2
	pxor	%xmm3,%xmm4
	movdqu	%xmm2,(%rdi,%rbp,1)
	movdqu	%xmm4,16(%rdi,%rbp,1)
	movdqa	%xmm5,64(%rsp,%rbp,1)
	movdqa	%xmm5,80(%rsp,%rbp,1)
	movdqa	%xmm5,(%rbx,%rbp,1)
	movdqa	%xmm5,16(%rbx,%rbp,1)
	leaq	32(%rbp),%rbp
	decq	%rcx
	jnz	.Lsqr4x_copy
	movq	56(%rsp),%rsi
